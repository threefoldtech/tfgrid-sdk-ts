...
window.env = {
  NETWORK: '$MODE',
  GRAPHQL_URL: "[$(parss_array $GRAPHQL_URL)]",
  GRIDPROXY_URL: "[$(parss_array $GRIDPROXY_URL)]",
  SUBSTRATE_URL: "[$(parss_array $SUBSTRATE_URL)]",
  ACTIVATION_SERVICE_URL:  "[$(parss_array $ACTIVATION_SERVICE_URL)]",
  RELAY_DOMAIN:  "[$(parss_array $RELAY_DOMAIN)]",
  BRIDGE_TFT_ADDRESS: '$BRIDGE_TFT_ADDRESS',
  STELLAR_NETWORK: '$STELLAR_NETWORK',
  STELLAR_HORIZON_URL: '$STELLAR_HORIZON_URL',
  TFT_ASSET_ISSUER: '$TFT_ASSET_ISSUER',
  MINTING_URL: '$MINTING_URL',
  STATS_URL: "[$(parss_array $STATS_URL)]",
  TIMEOUT: +'$TIMEOUT',
  PAGE_SIZE: +'$PAGE_SIZE',

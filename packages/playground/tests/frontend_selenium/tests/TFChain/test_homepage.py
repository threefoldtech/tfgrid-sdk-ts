...
def test_validate_homepage_links(browser):
    ...
    assert dashboard_page.navigate_to_learn_about_grid() == ('https://manual.dev.grid.tf/')
...
def test_manual_page(browser):
    ...
    dashboard_page = before_test_setup(browser)
    dashboard_page.press_esc_key()
    assert dashboard_page.manual_page() == 'https://manual.dev.grid.tf/'
...
def test_account_validation(browser):
    ...
    assert dashboard_page.manual_link() == 'https://manual.dev.grid.tf/labs/documentation/dashboard/wallet_connector/'
...
def test_login_links(browser):
    ...
    dashboard_page.open_profile()
    assert dashboard_page.manual_link() == 'https://manual.dev.grid.tf/labs/documentation/dashboard/wallet_connector/'
    assert dashboard_page.connect_manual_link() == 'https://www.manual.dev.grid.tf/labs/documentation/threefold_token/storing_tft/tf_connect_app/'

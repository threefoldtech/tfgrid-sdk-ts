<template>
  <view-layout>
    ...
    <v-text-field
      v-model="searchItem"
      label="Search for a lab"
      class="mb-5"
      clearable
    />
    <p
      v-if="filteredAppCards.length === 0 && filteredOrchCards.length === 0"
      class="mx-3 mb-3"
    >
    ...
    <v-card
      v-if="filteredOrchCards.length > 0"
      class="my-5"
      variant="text"
    >
      <v-card-title
    ...
    <v-divider
      v-if="filteredAppCards.length && filteredOrchCards.length"
      class="my-4"
    />
    <v-card
      v-if="filteredAppCards.length > 0"
      class="my-5"
      variant="text"
    >
      <v-card-title

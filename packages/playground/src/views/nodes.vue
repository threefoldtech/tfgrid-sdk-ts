<template>
  ...
  <view-layout>
    ...
    <div class="d-flex">
          ...
          >
            <template #region="{ props }">
              <TfFilter query-route="region" v-model="filters.region">
                <TfSelectRegion density="compact" :region-props="props" variant="outlined" />
              </TfFilter>
            </template>

            <template #country="{ props }">
              <TfFilter query-route="country" v-model="filters.country">
                <TfSelectCountry :country-props="props" density="compact" variant="outlined" />
              </TfFilter>
            </template>
          </TfSelectLocation>
      ...
      <div class="nodes" :style="{ width: 'calc(100% - 280px - 16px)' }">

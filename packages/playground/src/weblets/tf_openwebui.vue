<template>
  ...
  async function deploy() {
    ...
    try {
      ...
      layout.value.setStatus("success", "Successfully deployed an Open WebUI instance. You might need to wait a couple of minutes for the installation to complete, e.g. if you see Bad Gateway when opening the webpage, simply wait and refresh the page.");

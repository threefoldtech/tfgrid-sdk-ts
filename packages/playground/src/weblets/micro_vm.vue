  ...
  >
    ...
    >
      <template #config>
        ...
        <!-- <input-validator :value="cpu" :rules="[
        ...
        <!-- <input-validator :value="memory" :rules="[
...
import SelectSolutionFlavorSSD from "../components/select_solution_flavor_ssd.vue";

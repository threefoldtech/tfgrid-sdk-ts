  ...
  setup(props) {
    ...
    const getNodeTwinDetailsCard = (): NodeDetailsCard[] => {
      return [
        {
          name: "IPv4",
          value: props.node.publicConfig.ipv4 == "" ? "-" : props.node.publicConfig.ipv4,
        ...
        {
          name: "IPv6",
          value: props.node.publicConfig.ipv6 == "" ? "-" : props.node.publicConfig.ipv6,
          icon: "mdi-content-copy",
          callback: copy,
        ...
        {
          name: "GW4",
          value: props.node.publicConfig.gw4 == "" ? "-" : props.node.publicConfig.gw4,
          icon: "mdi-content-copy",
          callback: copy,
        ...
        {
          name: "GW6",
          value: props.node.publicConfig.gw6 == "" ? "-" : props.node.publicConfig.gw6,
          icon: "mdi-content-copy",
          callback: copy,
        ...
        {
          name: "Domain",
          value: props.node.publicConfig.domain == "" ? "-" : props.node.publicConfig.domain,
          icon: "mdi-content-copy",
          callback: copy,

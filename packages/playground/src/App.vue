          ...
          <v-container>
            <v-row justify="center" no-gutters>
              ...
              <v-col class="mx-3" cols="4" md="2">
                ...
                <div>
                  <a href="https://www.threefold.io/newsroom/" class="app-link text-subtitle-2" target="_blank"
                    >News Room</a
                  >
                </div>
                <div>
                  <a href="https://www.threefold.io/community/" class="app-link text-subtitle-2" target="_blank"
                    >Community</a
                  >
                </div>
              </v-col>
              ...
              <v-col class="mx-3" cols="2">
                ...
                <div>
                  <a href="https://t.me/threefoldfarmers" class="app-link text-subtitle-2" target="_blank"
                    >Farming Chat</a
                  >
                </div>
                <div>
                  <a href="https://t.me/threefoldtesting" class="app-link text-subtitle-2" target="_blank"
                    >Grid User Chat</a
                  >
                </div>
                <div>

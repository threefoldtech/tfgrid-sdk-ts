...
We provide a few images managed by Threefold like Ubuntu 22.04, and NixOS, but you can still use a custom one. For more details, check [Full Virtual Machine documentation](https://manual.dev.grid.tf/labs/documentation/dashboard/deploy/vm_intro/fullVm).

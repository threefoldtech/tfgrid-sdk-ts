...
async function deploy(client, vms, subdomain, gatewayNode) {
  ...
  const gw: GatewayNameModel = {
    ...
    backends: ["http://[" + vmPlanetary + "]:4444"],
  };
    ...
    machines: [
      {
        ...
        env: {
          ...
          // Update the Subsquid websocket endpoint for a supported substrate chain.
          CHAIN_ENDPOINT: "wss://polkadex-mainnet-rpc.dwellir.com",
        },
      },
    ],
    metadata: "",

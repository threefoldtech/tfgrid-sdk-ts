...
async function getDeployment(client, vms, gatewayName) {
  try {
    ...
    log(res);
    log(`You can access Subsquid via the browser using: http://${gatewayName}.yourdomain.com`);
    log("================= Getting VM deployment information =================");
  } catch (error) {
    ...
    machines: [
      {
        ...
        env: {
          ...
          CHAIN_ENDPOINT: "10.10.10.10",
          SUBSQUID_WEBSERVER_HOSTNAME: "gent02.dev.grid.tf",
        },
      },
    ],
    metadata: "",

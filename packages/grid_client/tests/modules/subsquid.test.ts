...
test("TC - Deploy subsquid", async () => {
  /**********************************************
     Test Suite: Grid3_Client_TS (Automated)
     Test Cases: TC - Deploy subsquid
     Scenario:
        ...
        - Verify the resources of the subsquid solution.
    **********************************************/
    ...
    machines: [
      {
        ...
        env: {
          ...
          SUBSQUID_WEBSERVER_HOSTNAME: "gent01.dev.grid.tf",
          SUBSQUID_REGISTRATION_CODE: "e5083a8d0a6362c6cf7a3078bfac81e3",
          SUBSQUID_BACKUP_PRI_KEY: "",
          SUBSQUID_BACKUP_PUB_KEY: "",
        },
  ...
  try {
    ...
    await ssh.execCommand("zinit").then(async function (result) {
      log(result.stdout);
      expect(result.stdout).toContain("subsquid: Running");
    });

...
test("TC - Deploy presearch", async () => {
  /**********************************************
     Test Suite: Grid3_Client_TS (Automated)
     Test Cases: TC - Deploy presearch
     Scenario:
        ...
        - Verify the resources of the presearch solution.
    **********************************************/
  ...
  try {
    ...
    await ssh.execCommand("zinit").then(async function (result) {
      log(result.stdout);
      expect(result.stdout).toContain("prenode: Success");
    });
